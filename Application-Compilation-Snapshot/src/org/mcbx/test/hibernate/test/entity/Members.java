package org.mcbx.test.hibernate.test.entity;
...
public class Members implements Serializable {
    ...
    public String toString() {
        return "Members{" + "idmembers=" + idmembers + ", idnumber=" + idnumber + ", firstname=" + firstname + ", middleinitial=" + middleinitial + ", lastname=" + lastname + ", dateofbirth=" + dateofbirth + ", gender=" + gender + ", address1=" + address1 + ", address2=" + address2 + ", phonenumber1=" + phonenumber1 + ", phonenumber2=" + phonenumber2 + ", emailaddress=" + emailaddress + ", registereddate=" + registereddate + ", membertype=" + membertype + ", isblocked=" + isblocked + ", username=" + username + ", password=" + password + '}';
    }
